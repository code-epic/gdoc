...
export class FirmadosComponent implements OnInit, OnDestroy {
  public titulo = "";

  public estadoActual = 4;
  public estadoOrigen = 8;
  fecha_desde = "-09-01";
  fecha_hasta = "-09-30";
  xyear = "2024";
  public lstMeses = [];
  ...
  ngOnInit(): void {
    ...
    this.listarEstados();
    this.titulo = "Documentos Firmados";
      ...
      async (data) => {
        switch (this.AccionTexto) {
          ...
          case "5": // Clasificar como RECLAMOS
            ...
            break;
          case "3": // Clasificar como TRAMITE POR ORGANO REGULAR
