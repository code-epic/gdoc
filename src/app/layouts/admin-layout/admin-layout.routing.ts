...
import { FirmadosComponent } from "src/app/views/secretaria/firmados/firmados.component";
...
import { ResueltosIosComponent } from "src/app/views/generales/resueltos_ios/resueltos_ios.component";
...
export const AdminLayoutRoutes: Routes = [
  ...
  {
    path: "resueltos_ios",
    component: ResueltosIosComponent,
    canActivate: [AuthGuardGuard],
  },
  {
